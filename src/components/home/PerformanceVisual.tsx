...
export function PerformanceVisual() {
    ...
    useEffect(() => {
        ...
        function draw() {
            ...
            const rings = [
                { radius: 160, progress: 0.78, color: '#22C55E', width: 5 },
                { radius: 130, progress: 0.62, color: '#38BDF8', width: 4 },
                { radius: 100, progress: 0.91, color: '#D946EF', width: 3.5 },
                { radius: 70, progress: 0.45, color: '#F59E0B', width: 3 },
            ];
            ...
            rings.forEach((ring) => {
                ...
                const animatedProgress = ring.progress * Math.min(1, time * 0.7);
                ...
                const tipGlow = ctx.createRadialGradient(tipX, tipY, 0, tipX, tipY, 10);
                tipGlow.addColorStop(0, ring.color + '60');
            ...
            ctx.fillText('96', cx, cy - 6);
            ctx.fillStyle = 'rgba(148, 163, 184, 0.5)';
            ctx.font = '500 10px Inter, sans-serif';
            ctx.fillText('SYSTEM SCORE', cx, cy + 20);
